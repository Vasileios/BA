...
BASpacePadA{
	...
	*new{
	...
	freqs = #[freq1, freq3, freq5aug], rings = #[0.1, 0.3, 0.4, 0.6, 1, 0.7, 0.02], freqres = 329.63, bwr = 0.7, trigger = 1, amp = 0.4, pan = 0, vol = 0.5|
	
	var env, source, rez, cutoff;
	
	
	
	env = EnvGen.kr(Env([0, 1, 0], [4, 4]), gate, doneAction: 2);
